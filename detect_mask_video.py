...
def detect_and_predict_mask(frame, faceNet, maskNet):
	...
	#The [:2] indexing is used to get the first two elements of the shape, which correspond to the height and width.
	(h, w) = frame.shape[:2]
	#The cv2.dnn.blobFromImage function is used to create a 4-dimensional blob from the input image (frame).
...
def project():
	...
	vs = VideoStream('http://192.168.137.240:4747/video').start()
